...
TrainingData_outdir = f'/my-projects2/1.project/NO2_DL_global/TrainingDatasets/{version}{special_name}/'
...
#######################################################################################################################
#######################################################################################################################
Observation_indir                   = f'/my-projects2/1.project/NO2_DL_global/TrainingDatasets/{version}{special_name}/'

BASE_INPUT_PATH                     = '/my-projects2/1.project/NO2_DL_global/input_variables/'

ML_NO2_input_indir                  = BASE_INPUT_PATH + 'ML_input/'

GeoNO2_input_indir                  = BASE_INPUT_PATH + 'GeoNO2_input/'
GeoNO2v513_input_indir              = BASE_INPUT_PATH + 'GeoNO2v5.13_input/'
...
def inputfiles_table(YYYY, MM):
    inputfiles_dic = {
        ...
        'GeoNO2v513_GC'      : GeoNO2v513_input_indir + '{}/GeoNO2v5.13_GC_001x001_Global_map_{}{}.npy'.format(YYYY,YYYY,MM),
        ...
        'SatColNO2_TM'          : Satellite_input_dir + '{}/SatColNO2_TM_001x001_Global_{}{}.npy'.format(YYYY,YYYY,MM),
        'SatColNO2_GC'          : Satellite_input_dir + '{}/SatColNO2_GC_001x001_Global_{}{}.npy'.format(YYYY,YYYY,MM),
        ...
        'lat'                : '/my-projects2/1.project/NO2_DL_global/input_variables/tSATLAT_global_MAP.npy',
        'lon'                : '/my-projects2/1.project/NO2_DL_global/input_variables/tSATLON_global_MAP.npy',
