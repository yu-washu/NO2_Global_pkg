...
START_YEAR=2023
END_YEAR=2023
MEM=400000           # in MB (≈320 GB)
SCRIPT="/my-projects2/1.project/NO2_DL_global/NO2_global_pkg/Data_Processing/Derive_Geophysical_NO2/GeoNO2/geono2_v5.1.py"
...
echo \"[\$(hostname)] Deriving GeoNO2 v5.1 monthly average: ${year}-${MONTH_STR}\"
echo \"Start time: \$(date)\"
echo \"Job ID: \$LSB_JOBID\"
ulimit -s unlimited
python3 -u ${SCRIPT} ${year} --month ${month} --plot-only
echo \"End time: \$(date)\"
