        ...
        MODULE DOUBLE_RIGHT_SLICER__genmod
          INTERFACE 
            SUBROUTINE DOUBLE_RIGHT_SLICER(YG,NYDIM,NYBOX,ORNT,PARS,    &
     &JOLD_L,JCNR_F,JCNR_D,JOLD_U,XOLD,YOLD_L,YOLD_U,XCNR_F,YCNR_F,     &
     &XCNR_D,YCNR_D,AREA)
          ...
          END INTERFACE 
        END MODULE DOUBLE_RIGHT_SLICER__genmod
