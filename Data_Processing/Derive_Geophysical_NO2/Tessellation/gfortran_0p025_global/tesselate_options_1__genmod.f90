        ...
        MODULE TESSELATE_OPTIONS_1__genmod
          INTERFACE 
            SUBROUTINE TESSELATE_OPTIONS_1(XGRID,YGRID,NXDIM,NYDIM,CC,  &
     &ORIENT,DOUBLE_FIRST,DOUBLE_LAST,PARS,ISTART1,ISTART2,ISTART3,     &
     &ISTART4,JFINIS,AREA,YLIMIT_LOWER,YLIMIT_UPPER)
          ...
          END INTERFACE 
        END MODULE TESSELATE_OPTIONS_1__genmod
