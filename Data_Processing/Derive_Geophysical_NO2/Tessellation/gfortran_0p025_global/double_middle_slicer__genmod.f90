        ...
        MODULE DOUBLE_MIDDLE_SLICER__genmod
          INTERFACE 
            SUBROUTINE DOUBLE_MIDDLE_SLICER(YG,NYDIM,NYBOX,ORNT,PARS,   &
     &JOLD_L,JOLD_U,JCNR_F,JCNR_D,JNEW_L,JNEW_U,XOLD,XNEW,YOLD_L,YOLD_U,&
     &YNEW_L,YNEW_U,XCNR_F,YCNR_F,XCNR_D,YCNR_D,AREA)
          ...
          END INTERFACE 
        END MODULE DOUBLE_MIDDLE_SLICER__genmod
