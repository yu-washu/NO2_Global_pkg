...
def average_daily_to_monthly(year, month):
    ...
    base_dir = '/my-projects2/1.project/NO2_col/OMI-MINDS/'
    ...
    try:
        ...
        print(f"  File successfully written. Exiting cleanly.")
        sys.exit(0)
...
def average_monthly_to_yearly(year):
    """
    Aggregate pre-computed monthly OMI-MINDS NO₂ means into a single yearly mean.
    """
    ...
    try:
        ...
        yearly_mean.attrs.update({
            'title': f'Yearly mean OMI-MINDS NO2 for {year}',
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Process OMI-MINDS NO2 data averaging')
