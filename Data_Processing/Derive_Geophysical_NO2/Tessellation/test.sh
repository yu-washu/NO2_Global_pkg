...
START="2019-07-01"
END="2019-07-02"
MEM=50000          # in MB (≈50 GB)
SCRIPT="/my-projects2/1.project/NO2_DL_global/NO2_global_pkg/Data_Processing/Derive_Geophysical_NO2/Tessellation/tess.py"
