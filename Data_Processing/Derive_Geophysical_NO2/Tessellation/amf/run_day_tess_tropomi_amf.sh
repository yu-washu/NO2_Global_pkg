...
SCRIPT="/my-projects2/1.project/NO2_DL_global/NO2_global_pkg/Data_Processing/Derive_Geophysical_NO2/Tessellation/amf/tess_TROPOMI_AMF.py"
...
python3 -u ${SCRIPT} --year ${DATE:0:4} --mon ${DATE:4:2} --day ${DATE:6:2} --no-plot
"
