...
def main():
    ...
    parser = argparse.ArgumentParser(description='Global NO2 scatter plot evaluation (GeoNO2 v5.8)')
    ...
    print(f"Starting global NO2 evaluation and visualization (GeoNO2 v5.8) for year {year}...")
