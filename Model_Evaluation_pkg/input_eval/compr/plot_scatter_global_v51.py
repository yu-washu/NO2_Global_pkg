...
def create_summary_statistics(gchp_geo_df):
    print("\n" + "="*80)
    print("GLOBAL SUMMARY STATISTICS (GeoNO2 v5.1)")
    print("="*80)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Global NO2 scatter plot evaluation (GeoNO2 v5.1)')
    ...
    print(f"Starting global NO2 evaluation and visualization (GeoNO2 v5.1) for year {year}...")
