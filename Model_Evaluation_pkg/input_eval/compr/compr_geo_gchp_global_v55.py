...
GCHP_Dir = f'/my-projects2/1.project/GeoNO2-v5.5/{year}/'
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Global NO2 evaluation (GeoNO2 v5.5)')
    ...
    print(f"Starting global NO2 evaluation (GeoNO2 v5.5) for year {year}...")
