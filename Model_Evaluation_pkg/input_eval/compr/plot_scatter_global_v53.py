...
def main():
    ...
    parser = argparse.ArgumentParser(description='Global NO2 scatter plot evaluation (GeoNO2 v5.3)')
    ...
    print(f"Starting global NO2 evaluation and visualization (GeoNO2 v5.3) for year {year}...")
