...
def load_and_process_data():
    annual_gchp_geo_file = os.path.join(data_dir, f'{species}_annual_{year}_obs{obs_version}.csv')
...
def create_global_figure(gchp_geo_df):
    ...
    # Save
    out_base = os.path.join(output_dir, f'{species}_global_{year}_obs{obs_version}')
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Global NO2 scatter plot evaluation')
    ...
    print(f"Starting global NO2 evaluation and visualization for year {year}...")
