...
GCHP_Dir = f'/my-projects2/1.project/GeoNO2-v5.7/{year}/'
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Global NO2 evaluation (GeoNO2 v5.7)')
    ...
    print(f"Starting global NO2 evaluation (GeoNO2 v5.7) for year {year}...")
